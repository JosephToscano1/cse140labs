...
c^*_{i+1} &= ((x_i \odot y_i) + c_i) \odot (x_i + y_i) \tag {Eq. 13}
\end{align*}
$$
...
In a theoretical implementation, the above two functions, equations 16-17, are generated by the ***PG Generator*** block.
